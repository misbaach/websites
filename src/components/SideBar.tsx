  ...
  return (
    <div>
      <button
        ...
        type="button"
        className="text-white0 ms-3 mt-2 inline-flex items-center rounded-lg p-2 text-sm hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 sm:hidden"
      >
      ...
      >
        <div className="h-full overflow-y-auto bg-white px-3 py-4">
          <Link to="/" className="mb-5 flex items-center ps-2.5">
            <img src={Logo} alt="logo semilearn" className="h-8" />
          </Link>
          <ul className="space-y-2 font-medium">
            <li>
              ...
              >
                <svg
                  className="text-white0 h-5 w-5 transition duration-75 group-hover:text-gray-900"
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="currentColor"
                  viewBox="0 0 22 21"
            ...
            <li>
              ...
              >
                <svg
                  className="text-white0 h-5 w-5 flex-shrink-0 transition duration-75 group-hover:text-gray-900"
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="currentColor"
                  viewBox="0 0 18 18"
      ...
      <div className="bg-gray-100 p-4 sm:ml-64">
        <div className="rounded-lg border-2 border-dashed border-white p-4">
          <div className="mb-4 grid grid-cols-3 gap-4">
            <div className="flex h-24 items-center justify-center rounded bg-white">
          ...
          <div className="mb-4 flex h-48 items-center justify-center rounded bg-white">
            <p className="text-2xl text-gray-400">
              <svg
                className="h-3.5 w-3.5"
                aria-hidden="true"
